...
public class MageVersion implements Serializable, Comparable<MageVersion> {
    ...
    public static final int MAGE_VERSION_RELEASE = 3;
    public static final String MAGE_VERSION_RELEASE_INFO = "XDHS-ME2-r1"; // V1, V1a, V1b for releases; V1-beta3, V1-beta4 for betas
