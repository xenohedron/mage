...
public class MageVersion implements Serializable, Comparable<MageVersion> {
    ...
    public static final int MAGE_VERSION_RELEASE = 4;
    public static final String MAGE_VERSION_RELEASE_INFO = "XDHS-r1"; // V1, V1a, V1b for releases; V1-beta3, V1-beta4 for betas
